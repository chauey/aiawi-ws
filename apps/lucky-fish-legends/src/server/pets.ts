...
// Pet configuration with enhanced visuals - 16 pets!
const PET_TYPES = {
	crab: { 
		name: "Red Crab 🦀", 
		bodyColor: Color3.fromRGB(220, 80, 60),
		accentColor: Color3.fromRGB(180, 50, 40),
		eyeColor: Color3.fromRGB(30, 30, 30),
		glowColor: Color3.fromRGB(255, 120, 100),
		magnetRange: 8, speed: 0.8, bobSpeed: 3, scale: 0.7,
	},
	fish: { 
		name: "Blue Fish 🐟", 
		bodyColor: Color3.fromRGB(100, 180, 255),
		accentColor: Color3.fromRGB(60, 140, 220),
		eyeColor: Color3.fromRGB(20, 20, 20),
		glowColor: Color3.fromRGB(150, 200, 255),
		magnetRange: 9, speed: 1.1, bobSpeed: 5, scale: 0.8,
	},
	turtle: { 
		name: "Green Turtle 🐢", 
		bodyColor: Color3.fromRGB(80, 180, 100),
		accentColor: Color3.fromRGB(60, 140, 80),
		eyeColor: Color3.fromRGB(40, 40, 40),
		glowColor: Color3.fromRGB(120, 200, 140),
		magnetRange: 10, speed: 0.7, bobSpeed: 2, scale: 0.9,
	},
	frog: { 
		name: "Lime Frog 🐸", 
		bodyColor: Color3.fromRGB(120, 220, 80),
		accentColor: Color3.fromRGB(80, 180, 50),
		eyeColor: Color3.fromRGB(255, 220, 50),
		glowColor: Color3.fromRGB(160, 255, 120),
		magnetRange: 10, speed: 1.2, bobSpeed: 6, scale: 0.75,
	},
	duck: { 
		name: "Yellow Duck 🦆", 
		bodyColor: Color3.fromRGB(255, 220, 80),
		accentColor: Color3.fromRGB(255, 160, 50),
		eyeColor: Color3.fromRGB(30, 30, 30),
		glowColor: Color3.fromRGB(255, 240, 150),
		magnetRange: 11, speed: 1.0, bobSpeed: 4, scale: 0.85,
	},
	cat: { 
		name: "Pink Cat 🐱", 
		...
		magnetRange: 10, speed: 1.3, bobSpeed: 4, scale: 1.0,
	},
	dog: { 
		name: "Blue Dog 🐕", 
		...
		magnetRange: 12, speed: 1.0, bobSpeed: 3, scale: 1.1,
	},
	rabbit: { 
		name: "White Rabbit 🐰", 
		bodyColor: Color3.fromRGB(255, 250, 245),
		accentColor: Color3.fromRGB(255, 200, 210),
		eyeColor: Color3.fromRGB(255, 100, 120),
		glowColor: Color3.fromRGB(255, 230, 240),
		magnetRange: 11, speed: 1.4, bobSpeed: 5, scale: 0.9,
	},
	fox: { 
		name: "Orange Fox 🦊", 
		bodyColor: Color3.fromRGB(255, 140, 50),
		accentColor: Color3.fromRGB(220, 100, 30),
		eyeColor: Color3.fromRGB(60, 40, 20),
		glowColor: Color3.fromRGB(255, 180, 100),
		magnetRange: 13, speed: 1.3, bobSpeed: 4, scale: 1.0,
	},
	bear: { 
		name: "Brown Bear 🐻", 
		bodyColor: Color3.fromRGB(140, 100, 70),
		accentColor: Color3.fromRGB(100, 70, 50),
		eyeColor: Color3.fromRGB(40, 30, 20),
		glowColor: Color3.fromRGB(180, 140, 100),
		magnetRange: 14, speed: 0.9, bobSpeed: 2, scale: 1.3,
	},
	penguin: { 
		name: "Tux Penguin 🐧", 
		...
		eyeColor: Color3.fromRGB(20, 20, 20),
		glowColor: Color3.fromRGB(150, 200, 255),
		magnetRange: 12, speed: 1.0, bobSpeed: 3, scale: 0.95,
	},
	owl: { 
		name: "Amber Owl 🦉", 
		bodyColor: Color3.fromRGB(160, 120, 80),
		accentColor: Color3.fromRGB(120, 80, 50),
		eyeColor: Color3.fromRGB(255, 200, 50),
		glowColor: Color3.fromRGB(200, 160, 100),
		magnetRange: 14, speed: 1.1, bobSpeed: 3, scale: 1.0,
	},
	bat: { 
		name: "Purple Bat 🦇", 
		...
		magnetRange: 15, speed: 1.5, bobSpeed: 6, scale: 0.9,
	},
	dragon: { 
		name: "Silver Dragon 🐉", 
		...
		magnetRange: 18, speed: 1.4, bobSpeed: 3, scale: 1.3,
	},
	unicorn: { 
		...
		magnetRange: 14, speed: 1.2, bobSpeed: 5, scale: 1.1,
	},
	phoenix: { 
		name: "Fire Phoenix 🔥", 
		bodyColor: Color3.fromRGB(255, 100, 30),
		accentColor: Color3.fromRGB(255, 50, 20),
		eyeColor: Color3.fromRGB(255, 255, 100),
		glowColor: Color3.fromRGB(255, 180, 50),
		magnetRange: 20, speed: 1.6, bobSpeed: 7, scale: 1.4,
	},
};
